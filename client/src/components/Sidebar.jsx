...
import { FaTachometerAlt, FaLaptop, FaUserShield, FaSignOutAlt, FaClock } from 'react-icons/fa'
...
export default function Sidebar() {
    ...
    return (
        ...
        <aside className="w-64 bg-white border-r border-gray-200 shadow-lg flex flex-col h-screen sticky top-0">
            ...
            <nav className="px-4 py-4 flex flex-col gap-2 flex-grow">
                ...
                {user?.role === 'admin' && (
                    <motion.div className="mt-4 pt-4 border-t border-gray-200">
                        <h3 className="text-xs uppercase font-semibold text-gray-500 mb-2">Admin Tools</h3>
